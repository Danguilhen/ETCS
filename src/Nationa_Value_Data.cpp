#include "National_Value_Data.hpp"
#include <cstdlib>
#include <iostream>
#include <thread>
#include <math.h>
...
cout << "Q_NVDRIVER_ADHES = " <<  Q_NVDRIVER_ADHES << " U" << endl;
cout << "V_NVSHUNT = " << V_NVSHUNT << " U" << endl;
cout << "V_NVSTFF = " << V_NVSTFF <<  " U" << endl;
cout << "V_NVONSIGHT = " << V_NVONSIGHT <<" U" << endl;
cout << "V_NVLIMSUPERV = " << V_NVLIMSUPERV <<" U" << endl;
cout << "V_NVUNFIT = " << V_NVUNFIT <<" U" << endl;
cout << "D_NVROLL = " << D_NVROLL <<" U" << endl;
cout << "Q_NVSBTSMPERM = " << Q_NVSBTSMPERM <<" U" << endl;
cout << "Q_NVEMRRLS = " << Q_NVEMRRLS << " " << endl;
cout << "Q_NVGUIPERM = " << Q_NVGUIPERM << " U" << endl;
cout << "Q_NVSBFBPERM = " << Q_NVSBFBPERM << " " << endl;
cout << "Q_NVINHSMICPERM = " << Q_NVINHSMICPERM << " U" << endl;
cout << "V_NVALLOWOVTRP = " <<V_NVALLOWOVTRP << " U" << endl;
cout << "V_NVSUPOVTRP = " << V_NVSUPOVTRP << " U" << endl;
cout << "D_NVOVTRP = " << D_NVOVTRP << " U" << endl;
cout << "T_NVOVTRP = " << T_NVOVTRP << " U" << endl;
cout << "M_NVDERUN = " << M_NVDERUN << " U" << endl;
cout << "M_NVCONTACT = " << M_NVCONTACT << " U" << endl;
cout << "T_NVCONTAC = " << T_NVCONTAC << " U" << endl;
cout << "D_NVPOTRP = " << D_NVPOTRP << " U" << endl;
cout << "D_NVSTFF = " << D_NVSTFF << " U" << endl;
cout << "Q_NVLOCACC = " << Q_NVLOCACC << " U" << endl;
cout << "M_NVAVADH = " << M_NVAVADH << " U" << endl;
cout << "M_NVEBCL = " << M_NVEBCL << " U" << endl;
cout << "L_NVKRINT = " << L_NVKRINT << " U" << endl;
cout << "M_NVKRINT = " << M_NVKRINT << " U" << endl;
cout << "V_NVKVINT = " << V_NVKVINT << " U" << endl;
cout << "M_NVKVINT = " << M_NVKVINT << " U" << endl;
cout << "M_NVKTINT = " << M_NVKTINT << " U" << endl;
cout << "A_NVMAXREDADH1 = " << A_NVMAXREDADH1 << " U" << endl;
cout << "A_NVMAXREDADH2 = " << A_NVMAXREDADH2 << " U" << endl;
cout << "A_NVMAXREDADH3 = " << A_NVMAXREDADH2 << " U" << endl;
cout << "A_NVP12 = " << A_NVP12 << " U" << endl;
cout << "A_NVP23 = " << A_NVP23 << " U" << endl;
