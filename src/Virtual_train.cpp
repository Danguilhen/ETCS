...
Virtual_train::Virtual_train() : etcs(soft, train_dynamique, reseau), basic(train_dynamique, soft), auxiliaire(train_dynamique, soft), train_dynamique(reseau), trainStatique(/*reseau*/)
{
    //cout<< "VT" <<endl;
    //constructeur
}
